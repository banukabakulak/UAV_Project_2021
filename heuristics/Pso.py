...
def PSO(ins, MaxIt, nPop, w, wdamp, c1, c2):
    # cost functions:
    cost_function = ins.CostFunctionForCell
    ...
    # the foolowing coefficient is stated as such in general PSO implementation:
    w = w  # intertia coefficient
    wdamp = wdamp  # damping ratio of intertia coefficient
