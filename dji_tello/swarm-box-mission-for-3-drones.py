...
tello1_address = ('192.168.1.100', 8889)
tello2_address = ('192.168.1.101', 8889)
...
def send(message1,message2,message3, delay):
...
send("speed 20")
send("takeoff","takeoff","takeoff",8)
#send("up 50", "up 100", "up 0", 4)
...
for i in range(4):
   # Fly forward
  send("forward " + str(box_leg_distance),"forward " + str(box_leg_distance),"forward " + str(box_leg_distance), 4)
   # Yaw right
  send("cw " + str(yaw_angle), "cw " + str(yaw_angle), "cw " + str(yaw_angle), 3)
# Land
send("land","land","land", 5)
# Print message
